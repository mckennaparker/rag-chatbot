...
if (st.button("Get Answer") and prompt):
    ...
    response = generate_answer(answers, prompt + "Please indicate in a seperate, italicized paragraph which document this information is contained in and where this information is located within that document.")
